...
cd /mnt/gentoo
wget https://www.gentoofan.org/gentoo/stage1/stage1-amd64-polyc-015.tar.bz2
tar xjpf stage1*.tar.bz2
rm -rf stage1*.tar.bz2
...
wget https://raw.githubusercontent.com/rjkeller/gentoo-bleeding-edge/master/kernel-virtualbox-4.9.config -O /usr/src/linux/.config
